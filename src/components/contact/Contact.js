...
const Contact = () => {
  ...
  return (
    <div className="isolate px-6 py-24 sm:py-32 lg:px-8 text-black">
      <div
      ...
      >
        ...
        <div className="mt-10 flex justify-center items-center">
          <button
            type="submit"
            className="block rounded-md  px-3.5 py-2.5 text-center text-sm font-semibold bg-gray-700 shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
